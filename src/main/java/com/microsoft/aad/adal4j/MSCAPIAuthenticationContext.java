 ...
 */
public class MSCAPIAuthenticationContext {

    private final Logger log = LoggerFactory
            .getLogger(MSCAPIAuthenticationContext.class);
     ...
     */
    public MSCAPIAuthenticationContext(final String authority,
     ...
     */
    public Future<AuthenticationResult> acquireToken(final String resource,
            final MSCAPIAsymmetricKeyCredential credential,
            final AuthenticationCallback callback)
            throws AuthenticationException {
    	this.authenticationAuthority.getSelfSignedJwtAudience();
    	MSCAPIJwtHelper.buildJwt(credential,
                this.authenticationAuthority.getSelfSignedJwtAudience());
        return this.acquireToken(resource, MSCAPIJwtHelper.buildJwt(credential,
                this.authenticationAuthority.getSelfSignedJwtAudience()),
                callback);
    }
     ...
     *         Token, Refresh Token and the Access Token's expiration time.
     * @throws AuthenticationException
     *             thrown if {@link MSCAPIAsymmetricKeyCredential} fails to sign the
     *             JWT token.
     */
    public Future<AuthenticationResult> acquireTokenByAuthorizationCode(
            final String authorizationCode, final URI redirectUri,
    ...
    public Future<AuthenticationResult> acquireTokenByAuthorizationCode(
            final String authorizationCode, final URI redirectUri,
            final MSCAPIAsymmetricKeyCredential credential, final String resource,
            final AuthenticationCallback callback)
            throws AuthenticationException {
        this.validateAuthCodeRequestInput(authorizationCode, redirectUri,
                credential, resource);
        return this.acquireTokenByAuthorizationCode(authorizationCode,
                redirectUri, MSCAPIJwtHelper
