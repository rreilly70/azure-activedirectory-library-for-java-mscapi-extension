 ...
 */
public final class MSCAPIAsymmetricKeyCredential {
     ...
     */
    private MSCAPIAsymmetricKeyCredential(final String clientId,
    ...
    public String getPublicCertificateHash()
        ...
        return Base64.encodeBase64String(MSCAPIAsymmetricKeyCredential
     ...
     */
    public static MSCAPIAsymmetricKeyCredential create(final String clientId,
    ...
    public static MSCAPIAsymmetricKeyCredential create(final String clientId,
            final PrivateKey key, final X509Certificate publicCertificate) {
        return new MSCAPIAsymmetricKeyCredential(clientId, key, publicCertificate);
    }
